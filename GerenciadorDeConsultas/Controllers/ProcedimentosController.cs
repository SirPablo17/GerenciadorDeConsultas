...
namespace GerenciadorDeConsultas.Controllers
{
    public class ProcedimentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProcedimentoID,ValorProcedimento,TempoProcedimento,DescricaoProcedimento")] Procedimento procedimento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProcedimentoID,ValorProcedimento,TempoProcedimento,DescricaoProcedimento")] Procedimento procedimento)
        {
